...
public class QueryBean {
    ...
    /**
     *
     * @param filterName 比较属性字符串, 含待比较的比较类型, 属性列表.
     *                  比如:new PropertyFilter("LIKE_name", "om");
     * @param value
     */
    public QueryBean (String filterName,String value) {

        String matchTypeCode = StringUtils.substringBefore(filterName, "_"); //LIKES
        ...
        propertyType = PropertyType.S.getValue();
