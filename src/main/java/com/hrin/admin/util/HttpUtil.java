...
public class HttpUtil {
     ...
     * @throws java.io.IOException
     */
    public static boolean urlGetMethodDownloadFile(String baseurl, Map<String, String> params, String pathAndFilename, String encoding, int timeout_msec) throws IOException {
        ...
        String queryString = getQueryString(params, encoding);
        ...
        try {
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                fileOutputStream = new FileOutputStream(new File(pathAndFilename));
                //这里的编码规则要与页面的相对应
                int inByte;
     ...
     * @throws java.io.IOException
     */
    public static String urlPostMethodWithBody(String baseurl, Map<String, String> headerParams, String bodyContent, String encoding, int timeout_msec) throws IOException {
        PostMethod postMethod = null;
        ...
        try {
            ...
            postMethod.setRequestEntity(new ByteArrayRequestEntity(bodyContent.getBytes(encoding)));
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                //这里的编码规则要与上面的相对应
                br = new BufferedReader(new InputStreamReader(is, responseEncoding));
            ...
            logger.error("发生网络异常, 请求url: {}", baseurl);
     ...
     * @throws java.io.IOException
     */
    public static String urlPostMethodWithFile(String baseurl, Map<String, String> paramsMap, String fileParamName, File file, String encoding, int timeout_msec) throws IOException {
        PostMethod postMethod = null;
        try {
            postMethod = new PostMethod(baseurl);
            postMethod.getParams().setParameter(HttpMethodParams.HTTP_CONTENT_CHARSET, encoding);
            ...
            FilePart fp = new FilePart(fileParamName, file);
            partList.add(fp);
     ...
     * @throws java.io.IOException
     */
    public static String postUrlWithBody(String baseurl, Map<String, String> headerParams, String bodyContent, String encoding, int timeout_msec) throws IOException {
        StringBuffer content = new StringBuffer((bodyContent != null) ? bodyContent : "");
	...
	public static void main(String[] args) throws Exception {
        String url = "http://116.255.219.248/index.php";

        String result = null;
        try {
            String s = HttpUtil.urlGetMethod(url, new HashMap<String, String>(), CharsetConstant.CHARSET_UTF8, 10000);
