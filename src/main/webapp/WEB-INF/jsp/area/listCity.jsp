...
<head>
    ...
    <script type="text/javascript">
        ...
        function rowformater(value,row,index) {
            var opt_str = "<a href='${ctx}/manage/area/update/" + row.id+ "'>修改</a>";
            return opt_str;
        }
    </script>
</head>
<body>
<table id="dg" style="width:700px;height:250px" title="您所在的位置：系统管理－>${province.name}->城市列表"
       data-options="
                    fit:true,
                    <%--toolbar:'#tb',--%>
                    fitColumns:true,
                    ...
                    <%--pagination:true,--%>
                    pageSize:'50',
                    url:'${ctx}/manage/area/list/city/${pid}',
